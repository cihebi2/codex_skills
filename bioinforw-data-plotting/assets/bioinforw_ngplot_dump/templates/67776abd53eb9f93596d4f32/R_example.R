...
data <- readr::read_file(paste0('demo_', '67776abd53eb9f93596d4f32', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '67776abd53eb9f93596d4f32', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '67776abd53eb9f93596d4f32',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

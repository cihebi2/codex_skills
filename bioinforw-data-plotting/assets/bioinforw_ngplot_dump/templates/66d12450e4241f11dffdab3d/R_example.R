...
data <- readr::read_file(paste0('demo_', '66d12450e4241f11dffdab3d', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '66d12450e4241f11dffdab3d', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '66d12450e4241f11dffdab3d',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'sample' ,  

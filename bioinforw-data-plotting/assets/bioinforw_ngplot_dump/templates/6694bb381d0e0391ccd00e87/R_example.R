...
data <- readr::read_file(paste0('demo_', '667d101971c06acd9bd3c9b1', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '667d101971c06acd9bd3c9b1', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '667d101971c06acd9bd3c9b1',
  data = datas,  
  arg = list(
    # params 
    xVCol = 'x' ,  

...
data <- readr::read_file(paste0('demo_', '66d4650e6d3485916d19321b', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '66d4650e6d3485916d19321b', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '66d4650e6d3485916d19321b',
  data = datas,  
  arg = list(
    # params 
    groupCol = 'group' ,  

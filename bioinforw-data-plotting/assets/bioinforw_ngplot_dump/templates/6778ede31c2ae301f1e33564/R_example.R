...
data <- readr::read_file(paste0('demo_', '6778ede31c2ae301f1e33564', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '6778ede31c2ae301f1e33564', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '6778ede31c2ae301f1e33564',
  data = datas,  
  arg = list(
    # params 
    valueCol = 'value' ,  

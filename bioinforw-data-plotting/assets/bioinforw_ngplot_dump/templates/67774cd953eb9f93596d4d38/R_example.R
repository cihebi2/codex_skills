...
data <- readr::read_file(paste0('demo_', '67774cd953eb9f93596d4d38', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '67774cd953eb9f93596d4d38', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '67774cd953eb9f93596d4d38',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

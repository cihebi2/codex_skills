...
data <- readr::read_file(paste0('demo_', '689fbf83b496cf3007e9fff8', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '689fbf83b496cf3007e9fff8', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '689fbf83b496cf3007e9fff8',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

...
data <- readr::read_file(paste0('demo_', '68ff30e4bb52e65911957081', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '68ff30e4bb52e65911957081', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '68ff30e4bb52e65911957081',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'group' ,  

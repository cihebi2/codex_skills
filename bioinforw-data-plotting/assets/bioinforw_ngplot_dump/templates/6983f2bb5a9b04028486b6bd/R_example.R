...
data <- readr::read_file(paste0('demo_', '6983f2bb5a9b04028486b6bd', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '6983f2bb5a9b04028486b6bd', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '6983f2bb5a9b04028486b6bd',
  data = datas,  
  arg = list(
    # params 
    groupCol = 'group' ,  

...
data <- readr::read_file(paste0('demo_', '666aba851a9a6da4e94c1c1d', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '666aba851a9a6da4e94c1c1d', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '666aba851a9a6da4e94c1c1d',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

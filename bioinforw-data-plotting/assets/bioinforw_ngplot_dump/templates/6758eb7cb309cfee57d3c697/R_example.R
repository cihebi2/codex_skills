...
data <- readr::read_file(paste0('demo_', '6758eb7cb309cfee57d3c697', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '6758eb7cb309cfee57d3c697', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '6758eb7cb309cfee57d3c697',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'VarName' ,  

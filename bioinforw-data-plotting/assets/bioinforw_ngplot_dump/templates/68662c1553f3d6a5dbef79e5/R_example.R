...
data <- readr::read_file(paste0('demo_', '68662c1553f3d6a5dbef79e5', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '68662c1553f3d6a5dbef79e5', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '68662c1553f3d6a5dbef79e5',
  data = datas,  
  arg = list(
    # params 
    sourceCol = 'source	' ,  

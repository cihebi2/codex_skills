...
data <- readr::read_file(paste0('demo_', '698cfef4eac3c16402b01d87', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '698cfef4eac3c16402b01d87', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '698cfef4eac3c16402b01d87',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

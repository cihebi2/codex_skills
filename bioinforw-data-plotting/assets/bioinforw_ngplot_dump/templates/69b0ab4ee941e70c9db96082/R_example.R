...
data <- readr::read_file(paste0('demo_', '69b0ab4ee941e70c9db96082', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '69b0ab4ee941e70c9db96082', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '69b0ab4ee941e70c9db96082',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

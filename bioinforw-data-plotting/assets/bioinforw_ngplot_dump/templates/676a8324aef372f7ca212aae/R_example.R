...
data <- readr::read_file(paste0('demo_', '676a8324aef372f7ca212aae', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '676a8324aef372f7ca212aae', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '676a8324aef372f7ca212aae',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

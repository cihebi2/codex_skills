...
data <- readr::read_file(paste0('demo_', '6777a96d53eb9f93596d6be4', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '6777a96d53eb9f93596d6be4', '_', 'data2', '.txt'))
datas[['data2']] <- data

data <- readr::read_file(paste0('demo_', '6777a96d53eb9f93596d6be4', '_', 'data3', '.txt'))
datas[['data3']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '6777a96d53eb9f93596d6be4',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

...
data <- readr::read_file(paste0('demo_', '69367e2a139236dfba8eecce', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '69367e2a139236dfba8eecce', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '69367e2a139236dfba8eecce',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

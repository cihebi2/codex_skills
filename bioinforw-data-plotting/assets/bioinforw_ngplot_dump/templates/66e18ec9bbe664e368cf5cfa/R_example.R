...
data <- readr::read_file(paste0('demo_', '66e18ec9bbe664e368cf5cfa', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '66e18ec9bbe664e368cf5cfa', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '66e18ec9bbe664e368cf5cfa',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

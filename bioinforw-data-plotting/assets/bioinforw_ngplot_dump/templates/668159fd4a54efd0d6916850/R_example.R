...
data <- readr::read_file(paste0('demo_', '668159fd4a54efd0d6916850', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '668159fd4a54efd0d6916850', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '668159fd4a54efd0d6916850',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

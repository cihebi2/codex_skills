...
data <- readr::read_file(paste0('demo_', '66ac2b714552a7ec5580c050', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '66ac2b714552a7ec5580c050', '_', 'data2', '.txt'))
datas[['data2']] <- data

data <- readr::read_file(paste0('demo_', '66ac2b714552a7ec5580c050', '_', 'data3', '.txt'))
datas[['data3']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '66ac2b714552a7ec5580c050',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

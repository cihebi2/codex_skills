...
data <- readr::read_file(paste0('demo_', '67787f8dd2113771d90c4ce0', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '67787f8dd2113771d90c4ce0', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '67787f8dd2113771d90c4ce0',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'id' ,  

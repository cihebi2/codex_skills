...
data <- readr::read_file(paste0('demo_', '6773ac61dd64bdf050ea409e', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '6773ac61dd64bdf050ea409e', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '6773ac61dd64bdf050ea409e',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

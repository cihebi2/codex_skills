...
data <- readr::read_file(paste0('demo_', '677546ff573a2e7111065530', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '677546ff573a2e7111065530', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '677546ff573a2e7111065530',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

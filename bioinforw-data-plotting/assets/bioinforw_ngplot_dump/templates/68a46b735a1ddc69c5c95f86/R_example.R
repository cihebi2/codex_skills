...
data <- readr::read_file(paste0('demo_', '68a46b735a1ddc69c5c95f86', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '68a46b735a1ddc69c5c95f86', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '68a46b735a1ddc69c5c95f86',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

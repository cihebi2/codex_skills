...
data <- readr::read_file(paste0('demo_', '677777de53eb9f93596d5241', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '677777de53eb9f93596d5241', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '677777de53eb9f93596d5241',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'id' ,  

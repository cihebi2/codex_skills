...
data <- readr::read_file(paste0('demo_', '66cea984bf89ff2f8e8cca3c', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '66cea984bf89ff2f8e8cca3c', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '66cea984bf89ff2f8e8cca3c',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

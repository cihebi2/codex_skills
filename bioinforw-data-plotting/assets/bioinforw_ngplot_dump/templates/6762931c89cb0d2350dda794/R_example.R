...
data <- readr::read_file(paste0('demo_', '6762931c89cb0d2350dda794', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '6762931c89cb0d2350dda794', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '6762931c89cb0d2350dda794',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

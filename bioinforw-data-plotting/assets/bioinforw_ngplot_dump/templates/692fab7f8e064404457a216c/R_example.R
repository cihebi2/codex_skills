...
data <- readr::read_file(paste0('demo_', '692fab7f8e064404457a216c', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '692fab7f8e064404457a216c', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '692fab7f8e064404457a216c',
  data = datas,  
  arg = list(
    # params 
    groupCol = 'layer' ,  

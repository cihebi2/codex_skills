...
data <- readr::read_file(paste0('demo_', '66a9b20bf00c758ce03e86cf', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '66a9b20bf00c758ce03e86cf', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '66a9b20bf00c758ce03e86cf',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  

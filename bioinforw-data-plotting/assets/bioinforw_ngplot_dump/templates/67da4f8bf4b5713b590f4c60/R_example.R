...
data <- readr::read_file(paste0('demo_', '67da4f8bf4b5713b590f4c60', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '67da4f8bf4b5713b590f4c60', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '67da4f8bf4b5713b590f4c60',
  data = datas,  
  arg = list(
    # params 
    groupCol = 'fertilizer' ,  

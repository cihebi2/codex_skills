...
data <- readr::read_file(paste0('demo_', '667cd1817addf6468a7b5d6e', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '667cd1817addf6468a7b5d6e', '_', 'data2', '.txt'))
datas[['data2']] <- data

data <- readr::read_file(paste0('demo_', '667cd1817addf6468a7b5d6e', '_', 'data3', '.txt'))
datas[['data3']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '667cd1817addf6468a7b5d6e',
  data = datas,  
  arg = list(
    # params 
    xVCol = 'x' ,  

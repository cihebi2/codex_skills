...
data <- readr::read_file(paste0('demo_', '667cdfd87addf6468a7b5f66', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '667cdfd87addf6468a7b5f66', '_', 'data2', '.txt'))
datas[['data2']] <- data

data <- readr::read_file(paste0('demo_', '667cdfd87addf6468a7b5f66', '_', 'data3', '.txt'))
datas[['data3']] <- data

data <- readr::read_file(paste0('demo_', '667cdfd87addf6468a7b5f66', '_', 'data4', '.txt'))
datas[['data4']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '667cdfd87addf6468a7b5f66',
  data = datas,  
  arg = list(
    # params 
    groupCol = 'group' ,  

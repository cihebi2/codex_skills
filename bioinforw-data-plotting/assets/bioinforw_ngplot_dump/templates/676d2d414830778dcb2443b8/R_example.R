...
data <- readr::read_file(paste0('demo_', '677901251c2ae301f1e33881', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '677901251c2ae301f1e33881', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '677901251c2ae301f1e33881',
  data = datas,  
  arg = list(
    # params 
    valueCol = 'value' ,  

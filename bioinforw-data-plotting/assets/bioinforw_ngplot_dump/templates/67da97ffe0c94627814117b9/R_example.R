...
data <- readr::read_file(paste0('demo_', '67da97ffe0c94627814117b9', '_', 'data1', '.txt'))
datas[['data1']] <- data

data <- readr::read_file(paste0('demo_', '67da97ffe0c94627814117b9', '_', 'data2', '.txt'))
datas[['data2']] <- data

ngplotPostData <- list(
  account = 'cihebi',
  ngplotApiKey = '',
  template = '67da97ffe0c94627814117b9',
  data = datas,  
  arg = list(
    # params 
    nameCol = 'name' ,  
